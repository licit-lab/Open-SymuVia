...
namespace SymuCore {
	...
	class SYMUCORE_DLL_DEF TravelIndicatorClass
	{
		public:

			TravelIndicatorClass();
			TravelIndicatorClass(double dbLowerBound, double dbUpperBound, bool bActive, int nMaxNbPoints, int nNbPointsForSigma);
			virtual ~TravelIndicatorClass();
			...
			double	GetTravelTime() { return m_dbTravelTime; };
			double	GetTravelSpeed() { return m_dbTravelSpeed; };
		...
		private:
			...
			double	m_dbTravelTime;		// Travel time for the class
			double	m_dbTravelSpeed;	// Travel speed for the class
