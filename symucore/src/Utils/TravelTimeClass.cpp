...
TravelTimeClass::TravelTimeClass()
{
	m_dbLowerBound = 0;		
	m_dbUpperBound = 0;		
...
TravelTimeClass::TravelTimeClass(double dbLowerBound, double dbUpperBound, bool bActive, int nMaxNbPoints, int nNbPointsForSigma)
{
...
bool TravelTimeClass::AddPoint(double dbLength, double ttt, double ttd)
{
...
//	m_bActive = true;
	...
	m_dbTT = dbLength / (m_dbAverageTTD / m_dbAverageTTT);
