...
protected:
    ...
    // flag indiquant si ce capteur MFD a �t� d�fini par l'utilisateur comme un capteur d'Edie 
    bool                     m_bIsEdie;

    // Longueurs g�om�triques calcul�es une fois pour toutes
    double                   m_bGeomLength1;
    double                   m_bGeomLength2;
    double                   m_bGeomLength3;

    // true si capteur MFD simple (on veut uniquement le temps pass� et distance parcourue pour calcul vitesse moyenne spatialis�e pour SymuMaster, sans cr�er de capteurs ponctuels par exemple)
    bool                     m_bSimpleMFD;
