...
<<<<<<< .mine
SYMUBRUIT_EXPORT int SYMUBRUIT_CDECL SymLoadNetwork(SymuCore::IUserHandler * pUserHandler, std::string sTmpXmlDataFile, int marginalsDeltaN, bool bUseMarginalsMeanMethod, bool bUseMarginalsMedianMethod, int nbVehiclesForMarginals, int nbPeriodsForMarginals, bool bUseSpatialTTMethod, bool bUseClassicSpatialMethodForTTMeasurement,
	...
	int nNbClassRobustTTMethod, int nMaxNbPointsPerClassRobustTTMethod, int nMinNbPointsStatisticalFilterRobustTTMethod,
	bool bUseLastBusIfAnyForTravelTimes, bool bUseEmptyTravelTimesForBusLines, double dbMeanBusExitTime, int nbStopsToConnectOutsideOfSubAreas, double dbMaxInitialWalkRadius, double dbMaxIntermediateWalkRadius, bool bComputeAllCosts, double dbMinLengthForMarginals,
	std::string sRobustTravelTimesFile, boost::posix_time::ptime & startTime, boost::posix_time::ptime & endTime, boost::posix_time::time_duration & timeStep, bool & bHasTrajectoriesOutput);
||||||| .r1099
SYMUBRUIT_EXPORT int SYMUBRUIT_CDECL SymLoadNetwork(SymuCore::IUserHandler * pUserHandler, std::string sTmpXmlDataFile, int marginalsDeltaN, bool bUseMarginalsMeanMethod, bool bUseMarginalsMedianMethod, int nbVehiclesForMarginals, int nbPeriodsForMarginals, bool bUseSpatialTTMethod,
    bool bEstimateTrafficLightsWaitTime, double dbMinSpeedForTravelTimes, double dbMaxMarginalsValue, bool bUseTravelTimesAsMarginalsInAreas, double dbConcentrationRatioForFreeFlowCriterion,
    bool bUseLastBusIfAnyForTravelTimes, bool bUseEmptyTravelTimesForBusLines, double dbMeanBusExitTime, int nbStopsToConnectOutsideOfSubAreas, double dbMaxInitialWalkRadius, double dbMaxIntermediateWalkRadius, bool bComputeAllCosts, double dbMinLengthForMarginals,
...
SYMUBRUIT_EXPORT int SYMUBRUIT_CDECL SymLoadNetwork(SymuCore::IUserHandler * pUserHandler, std::string sTmpXmlDataFile, int marginalsDeltaN, bool bUseMarginalsMeanMethod,
	...
	std::string sRobustTravelTimesFile,
	boost::posix_time::ptime & startTime, boost::posix_time::ptime & endTime, boost::posix_time::time_duration & timeStep, bool & bHasTrajectoriesOutput);
>>>>>>> .r1104
...
SYMUBRUIT_EXPORT int SYMUBRUIT_CDECL SymDriveVehicle(int nID, double dbX, double dbY, double dbZ, bool bForce);
...
SYMUBRUIT_EXPORT int   SYMUBRUIT_CDECL SymGetTrafficStateOnRemainingPath(int nIDVeh, std::string &json);
