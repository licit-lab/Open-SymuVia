#pragma once
#ifndef _JSONDOCTRAFIC_H
#define _JSONDOCTRAFIC_H
...
class JSONDocTrafic : public DocTrafic 
{
  public:
     JSONDocTrafic(void);

    virtual  ~JSONDocTrafic(void);


  private:
    rapidjson::Document m_TrafState;

  public:
    // Obtention des informations du trafic
    rapidjson::Document & GetTrafficState();
