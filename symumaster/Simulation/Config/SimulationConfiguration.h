...
namespace SymuMaster {
    ...
    public:
        ...
        const std::string & GetNetworksInterfacesFilePath() const;
        ...
        int GetMaxParallelSimulationsNb() const;
    ...
    protected:
        ...
        int m_iMaxNumberOfParallelSimulations;
        ...
        std::string m_strNetworksInterfacesFile;
